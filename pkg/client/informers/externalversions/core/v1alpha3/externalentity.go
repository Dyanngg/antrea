...
import (
	...
	corev1alpha3 "github.com/vmware-tanzu/antrea/pkg/apis/core/v1alpha3"
	...
	v1alpha3 "github.com/vmware-tanzu/antrea/pkg/client/listers/core/v1alpha3"
...
type ExternalEntityInformer interface {
	...
	Lister() v1alpha3.ExternalEntityLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CoreV1alpha3().ExternalEntities(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CoreV1alpha3().ExternalEntities(namespace).Watch(context.TODO(), options)
			},
		},
		&corev1alpha3.ExternalEntity{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *externalEntityInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1alpha3.ExternalEntity{}, f.defaultInformer)
}

func (f *externalEntityInformer) Lister() v1alpha3.ExternalEntityLister {
	return v1alpha3.NewExternalEntityLister(f.Informer().GetIndexer())
}
