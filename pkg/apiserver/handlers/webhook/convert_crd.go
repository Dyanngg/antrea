...
func HandleConversionClusterGroup() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		klog.V(2).Info("Received request to convert ClusterGroup CRD")
		var body []byte
		if r.Body != nil {
		...
		case v1beta1.SchemeGroupVersion.WithKind("ConversionReview"):
			...
			convertReview.Response = doConversionV1beta1(convertReview.Request, grouping.ConvertClusterGroupCRD)
		...
		case v1.SchemeGroupVersion.WithKind("ConversionReview"):
			...
			convertReview.Response = doConversionV1(convertReview.Request, grouping.ConvertClusterGroupCRD)
			convertReview.Response.UID = convertReview.Request.UID
			klog.V(2).Info(fmt.Sprintf("sending response: %v", convertReview.Response))
