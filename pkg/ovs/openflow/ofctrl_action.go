...
// LoadInPort is an action to load data to NXM_OF_IN_PORT field.
func (a *ofFlowAction) LoadInPort(value uint16) FlowBuilder {
	loadAct, _ := ofctrl.NewNXLoadAction(NxmFieldInPort, uint64(value), openflow13.NewNXRange(0, 15))
	a.builder.ApplyAction(loadAct)
	return a.builder
}
