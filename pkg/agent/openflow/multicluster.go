...
var GlobalVirtualMACForMulticluster, _ = net.ParseMAC("ff:ee:dd:cc:bb:aa")
...
func (f *featureMulticluster) snatConntrackFlows(serviceCIDR net.IPNet, localGatewayIP net.IP) []binding.Flow {
	...
	flows = append(flows,
		// This generates the flow to transform destination IP of reply packets from tracked
		// cross-cluster SNATed Service connection committed in SNAT CT zone.
