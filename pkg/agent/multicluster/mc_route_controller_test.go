...
func TestMCRouteControllerAsGateway(t *testing.T) {
	...
	go func() {
		...
		c.ofClient.EXPECT().InstallMulticlusterClassifierFlows("gw-"+gateway1.Name, uint32(1), true).Times(1)
		...
		c.ofClient.EXPECT().InstallMulticlusterGatewayFlows(getCacheKeyWithPrefix(clusterInfoImport1.Spec.ClusterID),
		...
		c.ofClient.EXPECT().InstallMulticlusterGatewayFlows(getCacheKeyWithPrefix(clusterInfoImport2.Spec.ClusterID),
		...
		c.ofClient.EXPECT().UninstallMulticlusterFlows(getCacheKeyWithPrefix(clusterInfoImport2.Spec.ClusterID)).Times(1)
		c.processNextWorkItem()
		...
		c.ofClient.EXPECT().UninstallMulticlusterFlows("gw-" + gateway1.Name).Times(1)
		c.ofClient.EXPECT().UninstallMulticlusterFlows(getCacheKeyWithPrefix(clusterInfoImport1.Spec.ClusterID)).Times(1)
		c.ofClient.EXPECT().InstallMulticlusterClassifierFlows(gateway2.Name, uint32(1), false).Times(1)
		c.ofClient.EXPECT().InstallMulticlusterNodeFlows(getCacheKeyWithPrefix(gateway2.Name+
			clusterInfoImport1.Spec.ClusterID), gomock.Any(), gw2InternalIP).Times(1)
		c.processNextWorkItem()
		...
		c.ofClient.EXPECT().UninstallMulticlusterFlows("gw-" + gateway2.Name).Times(1)
		c.ofClient.EXPECT().UninstallMulticlusterFlows(getCacheKeyWithPrefix(
			clusterInfoImport1.Spec.ClusterID)).Times(1)
		c.ofClient.EXPECT().InstallMulticlusterClassifierFlows("gw-"+gateway1.Name, uint32(1), true).Times(1)
		c.ofClient.EXPECT().InstallMulticlusterGatewayFlows(getCacheKeyWithPrefix(clusterInfoImport1.Spec.ClusterID),
			gomock.Any(), peerNodeIP1, gw1GatewayIP).Times(1)
		c.processNextWorkItem()
...
func TestMCRouteControllerAsRegularNode(t *testing.T) {
	...
	go func() {
		...
		c.mcClient.MulticlusterV1alpha1().ClusterInfoImports(clusterInfoImport1.GetNamespace()).
			Create(context.TODO(), &clusterInfoImport1, metav1.CreateOptions{})
		c.ofClient.EXPECT().InstallMulticlusterNodeFlows(getCacheKeyWithPrefix(gateway1.Name+
			clusterInfoImport1.Spec.ClusterID),
		...
		c.mcClient.MulticlusterV1alpha1().ClusterInfoImports(clusterInfoImport2.GetNamespace()).
			Create(context.TODO(), &clusterInfoImport2, metav1.CreateOptions{})
		c.ofClient.EXPECT().InstallMulticlusterNodeFlows(getCacheKeyWithPrefix(gateway1.Name+
			clusterInfoImport2.Spec.ClusterID),
			gomock.Any(), peerNodeIP1).Times(1)
		c.processNextWorkItem()
		...
		c.mcClient.MulticlusterV1alpha1().ClusterInfoImports(clusterInfoImport2.GetNamespace()).Delete(context.TODO(),
			clusterInfoImport2.Name, metav1.DeleteOptions{})
		c.ofClient.EXPECT().UninstallMulticlusterFlows(getCacheKeyWithPrefix(gateway1.Name +
			clusterInfoImport2.Spec.ClusterID)).Times(1)
		c.processNextWorkItem()
		...
		c.ofClient.EXPECT().InstallMulticlusterClassifierFlows(gateway2.Name, uint32(1), false).Times(1)
		c.ofClient.EXPECT().InstallMulticlusterNodeFlows(getCacheKeyWithPrefix(gateway2.Name+
			clusterInfoImport1.Spec.ClusterID), gomock.Any(), peerNodeIP2).Times(1)
		...
		c.ofClient.EXPECT().UninstallMulticlusterFlows(getCacheKeyWithPrefix(gateway2.Name +
			clusterInfoImport1.Spec.ClusterID)).Times(1)
		c.ofClient.EXPECT().InstallMulticlusterClassifierFlows(gateway1.Name, uint32(1), false).Times(1)
		c.ofClient.EXPECT().InstallMulticlusterNodeFlows(getCacheKeyWithPrefix(gateway1.Name+
			clusterInfoImport1.Spec.ClusterID), gomock.Any(), peerNodeIP1).Times(1)
		c.processNextWorkItem()
