...
// which is only used for security purpose of StretchedNetworkPolicy. The security
// rule arbitrarily drops all traffic initiated from Pods with UnknownLabelIdentity.
