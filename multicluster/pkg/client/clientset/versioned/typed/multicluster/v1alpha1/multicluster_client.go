...
func (c *MulticlusterV1alpha1Client) ClusterImportControls(namespace string) ClusterImportControlInterface {
	return newClusterImportControls(c, namespace)
}
