...
func (c *FakeMulticlusterV1alpha1) ClusterImportControls(namespace string) v1alpha1.ClusterImportControlInterface {
	return &FakeClusterImportControls{c, namespace}
}
