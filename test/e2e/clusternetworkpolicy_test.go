...
func testCNPPrioirtyOverrideDefaultDeny(t *testing.T) {
...
func testCNPDropEgress(t *testing.T) {
	builder := &ClusterNetworkPolicySpecBuilder{}
	builder = builder.SetName("cnp-deny-a-to-z").
		SetPriority(1.0).
		SetAppliedToGroup(map[string]string{"pod": "a"}, nil, nil, nil)
...
func testCNPPrioirtyOverride(t *testing.T) {
	builder1 := &ClusterNetworkPolicySpecBuilder{}
...
func testCNPRulePrioirty(t *testing.T) {
	builder1 := &ClusterNetworkPolicySpecBuilder{}
	// cnp-deny will apply to all pods with label a or in namespace x
	...
	builder2 := &ClusterNetworkPolicySpecBuilder{}
	// cnp-allow will also apply to all pods with label a or in namespace x
	builder2 = builder2.SetName("cnp-allow").
		SetPriority(5).
		SetAppliedToGroup(map[string]string{"pod": "a"}, nil, nil, nil).
		SetAppliedToGroup(nil, map[string]string{"ns": "x"}, nil, nil)
	...
	// Only egress from pods with label a or in namespace x to namespace y should be denied
	reachabilityBothCNP := NewReachability(allPods, true)
	...
	reachabilityBothCNP.Expect(Pod("y/a"), Pod("y/b"), false)
	reachabilityBothCNP.Expect(Pod("y/a"), Pod("y/c"), false)
	reachabilityBothCNP.Expect(Pod("z/a"), Pod("y/a"), false)
	reachabilityBothCNP.Expect(Pod("z/a"), Pod("y/b"), false)
	reachabilityBothCNP.Expect(Pod("z/a"), Pod("y/c"), false)
...
func TestClusterNetworkPolicy(t *testing.T) {
	...
	t.Run("TestGroupDefaultDENY", func(t *testing.T) {
		...
		t.Run("Case=CNPPrioirtyOverrideDefaultDeny", func(t *testing.T) { testCNPPrioirtyOverrideDefaultDeny(t) })
	...
	t.Run("TestGroupNoK8sNP", func(t *testing.T) {
		...
		t.Run("Case=CNPPrioirtyOverride", func(t *testing.T) { testCNPPrioirtyOverride(t) })
