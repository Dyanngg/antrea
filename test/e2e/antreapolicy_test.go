...
var (
	...
	selfNamespace                               *crdv1alpha1.PeerNamespaces
)
...
func testMutateANPNoTier(t *testing.T) {
	...
	builder = builder.SetName(getNS("x"), "anp-no-tier").
...
func testMutateACNPNoRuleName(t *testing.T) {
	...
	builder = builder.SetName("acnp-no-rule-name").
		SetAppliedToGroup([]ACNPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}}).
		SetPriority(10.0).
		AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("x")},
			nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "", nil)
	acnp := builder.Get()
	acnp, err := k8sUtils.CreateOrUpdateACNP(acnp)
	if err != nil {
		failOnError(fmt.Errorf("ACNP create failed %v", err), t)
...
func testMutateANPNoRuleName(t *testing.T) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-no-rule-name").
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}}).
		SetPriority(10.0).
		AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("x")}, nil,
...
func testInvalidANPNoPriority(t *testing.T) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-no-priority").
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
	anp := builder.Get()
	if _, err := k8sUtils.CreateOrUpdateANP(anp); err == nil {
		// Above creation of ANP must fail as it is an invalid spec.
...
func testInvalidANPRuleNameNotUnique(t *testing.T) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-rule-Name-not-unique").
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}}).
		AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("x")}, nil,
			nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "not-unique").
		AddIngress(ProtocolTCP, &p81, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "c"}, map[string]string{"ns": getNS("x")}, nil,
			nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "not-unique")
	anp := builder.Get()
	if _, err := k8sUtils.CreateOrUpdateANP(anp); err == nil {
		// Above creation of ANP must fail as it is an invalid spec.
...
func testInvalidANPTierDoesNotExist(t *testing.T) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-tier-not-exist").
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}}).
...
func testInvalidANPPortRangePortUnset(t *testing.T) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("y"), "anp-egress-port-range-port-unset").
		SetPriority(1.0).
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "b"}}})
	builder.AddEgress(ProtocolTCP, nil, nil, &p8085, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "c"}, map[string]string{"ns": getNS("x")}, nil,
...
func testInvalidANPPortRangeEndPortSmall(t *testing.T) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("y"), "anp-egress-port-range-endport-small").
		SetPriority(1.0).
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "b"}}})
	builder.AddEgress(ProtocolTCP, &p8082, nil, &p8081, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "c"}, map[string]string{"ns": getNS("x")}, nil,
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "anp-port-range")
...
func testInvalidTierANPRefDelete(t *testing.T) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-for-tier").
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}}).
...
func testACNPAllowXBtoA(t *testing.T) {
	...
	builder = builder.SetName("acnp-allow-xb-to-a").
		SetPriority(1.0).
		SetAppliedToGroup([]ACNPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
	builder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("x")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "", nil)
...
func testACNPAllowXBtoYA(t *testing.T) {
	...
	builder.AddIngress(ProtocolTCP, nil, &port81Name, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("x")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "", nil)
...
func testACNPPriorityOverrideDefaultDeny(t *testing.T) {
	...
	builder1.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "", nil)
	...
	builder2.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
...
func testACNPAllowNoDefaultIsolation(t *testing.T, protocol AntreaPolicyProtocol) {
	...
	builder = builder.SetName("acnp-allow-x-ingress-y-egress-z").
		SetPriority(1.1).
		SetAppliedToGroup([]ACNPAppliedToSpec{{NSSelector: map[string]string{"ns": getNS("x")}}})
	builder.AddIngress(protocol, &p81, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("y")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "", nil)
	builder.AddEgress(protocol, &p81, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "", nil)
...
func testACNPDropEgress(t *testing.T, protocol AntreaPolicyProtocol) {
	...
	builder = builder.SetName("acnp-deny-a-to-z-egress").
		SetPriority(1.0).
		SetAppliedToGroup([]ACNPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
	builder.AddEgress(protocol, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
...
func testACNPNoEffectOnOtherProtocols(t *testing.T) {
	...
	builder = builder.SetName("acnp-deny-a-to-z-ingress").
		SetPriority(1.0).
		SetAppliedToGroup([]ACNPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
	builder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
...
func testACNPIngressRuleDenyCGWithXBtoYA(t *testing.T) {
	...
	builder.AddIngress(ProtocolTCP, nil, &port81Name, nil, nil, nil, nil, nil, nil, nil, nil,
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, cgName, "", nil)
...
func testACNPAppliedToRuleCGWithPodsAToNsZ(t *testing.T) {
	...
	builder = builder.SetName("acnp-deny-cg-with-a-to-z").
		SetPriority(1.0)
	builder.AddEgress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, []ACNPAppliedToSpec{{Group: cgName}}, crdv1alpha1.RuleActionDrop, "", "", nil)
...
func testACNPClusterGroupAppliedToPodAdd(t *testing.T, data *TestData) {
	...
	builder = builder.SetName("acnp-deny-cg-with-zj-to-xj-egress").
		SetPriority(1.0).
		SetAppliedToGroup([]ACNPAppliedToSpec{{Group: cgName}})
	builder.AddEgress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "j"}, map[string]string{"ns": getNS("x")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
	cp := []*CustomProbe{
		{
			SourcePod: CustomPod{
...
func testACNPClusterGroupRefRuleIPBlocks(t *testing.T) {
	...
	builder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, cgv1a3Name, "", nil)
	builder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, cgv1a2Name, "", nil)
...
func testANPEgressRulePodsAToGrpWithPodsC(t *testing.T) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-deny-xa-to-grp-xc-egress").
		SetPriority(1.0).
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
...
func testANPIngressRuleDenyGrpWithXCtoXA(t *testing.T) {
	...
	port81Name := "serve-81"
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-deny-grp-with-xb-to-xa").
		SetPriority(2.0).
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
...
func testANPGroupUpdate(t *testing.T) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-deny-xa-to-grp-with-xc-egress").
		SetPriority(1.0).
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
	builder.AddEgress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, grpName, "")
...
func testANPAppliedToDenyXBtoGrpWithXA(t *testing.T) {
	...
	port81Name := "serve-81"
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-deny-grp-with-xa-from-xb").
		SetPriority(2.0).
...
func testANPAppliedToRuleGrpWithPodsAToPodsC(t *testing.T) {
	...
	grpBuilder = grpBuilder.SetName(grpName).SetNamespace(getNS("x")).SetPodSelector(map[string]string{"pod": "a"}, nil)
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-deny-grp-with-a-to-c").
		SetPriority(1.0)
...
func testANPGroupUpdateAppliedTo(t *testing.T) {
	...
	updatedGrpBuilder = updatedGrpBuilder.SetName(grpName).SetNamespace(getNS("x")).SetPodSelector(map[string]string{"pod": "b"}, nil)
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-deny-grp-xc-to-xa-egress").
		SetPriority(1.0).
		SetAppliedToGroup([]ANPAppliedToSpec{{Group: grpName}})
	builder.AddEgress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "c"}, nil, nil,
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "")
...
func testANPGroupAppliedToPodAdd(t *testing.T, data *TestData) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-deny-grp-with-xj-to-xd-egress").
		SetPriority(1.0).
		SetAppliedToGroup([]ANPAppliedToSpec{{Group: grpName}})
...
func testANPGroupServiceRefPodAdd(t *testing.T, data *TestData) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-grp-svc-ref").SetPriority(1.0).SetAppliedToGroup([]ANPAppliedToSpec{{Group: grp1Name}})
...
func testANPGroupRefRuleIPBlocks(t *testing.T) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-deny-xb-xc-ips-ingress-for-xa").
		SetPriority(1.0).
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
	builder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, grpName, "")
...
func testANPNestedGroupCreateAndUpdate(t *testing.T, data *TestData) {
	...
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("x"), "anp-nested-grp").SetPriority(1.0).
...
func testBaselineNamespaceIsolation(t *testing.T) {
	...
	builder = builder.SetName("acnp-baseline-isolate-ns-x").
		...
		SetAppliedToGroup([]ACNPAppliedToSpec{{NSSelector: map[string]string{"ns": getNS("x")}}})
	builder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		nil, []metav1.LabelSelectorRequirement{nsExpOtherThanX}, nil,
...
func testACNPPriorityOverride(t *testing.T) {
	...
	builder1.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
	...
	builder3.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
...
func testACNPRulePriority(t *testing.T) {
	...
	builder1 = builder1.SetName("acnp-deny").
		SetPriority(5).
		SetAppliedToGroup([]ACNPAppliedToSpec{{NSSelector: map[string]string{"ns": getNS("x")}}})
	builder1.AddEgress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("y")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
	// This rule should take no effect as it will be overridden by the first rule of cnp-allow
	builder1.AddEgress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
	...
	builder2 = builder2.SetName("acnp-allow").
		SetPriority(5).
		SetAppliedToGroup([]ACNPAppliedToSpec{{NSSelector: map[string]string{"ns": getNS("x")}}})
	builder2.AddEgress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "", nil)
	// This rule should take no effect as it will be overridden by the first rule of cnp-drop
	builder2.AddEgress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("y")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "", nil)
...
func testACNPPortRange(t *testing.T) {
	...
	builder = builder.SetName("acnp-deny-a-to-z-egress-port-range").
		SetPriority(1.0).
		SetAppliedToGroup([]ACNPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
	builder.AddEgress(ProtocolTCP, &p8080, nil, &p8082, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "acnp-port-range", nil)
...
func testACNPRejectEgress(t *testing.T) {
	...
	builder = builder.SetName("acnp-reject-a-to-z-egress").
		...
		SetAppliedToGroup([]ACNPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
	builder.AddEgress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionReject, "", "", nil)
...
func testACNPRejectIngress(t *testing.T, protocol AntreaPolicyProtocol) {
	...
	builder = builder.SetName("acnp-reject-a-from-z-ingress").
		SetPriority(1.0).
		SetAppliedToGroup([]ACNPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}}})
	builder.AddIngress(protocol, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionReject, "", "", nil)
...
func testRejectNoInfiniteLoop(t *testing.T, data *TestData) {
	...
	builder1.AddIngress(ProtocolTCP, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"app": "nginx"}, nil,
		nil, nil, nil, []ACNPAppliedToSpec{{PodSelector: map[string]string{"antrea-e2e": clientName}}}, crdv1alpha1.RuleActionReject, "", "", nil)
	builder1.AddIngress(ProtocolTCP, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"antrea-e2e": clientName}, nil,
		nil, nil, nil, []ACNPAppliedToSpec{{PodSelector: map[string]string{"app": "nginx"}}}, crdv1alpha1.RuleActionReject, "", "", nil)
...
func testANPPortRange(t *testing.T) {
	builder := &AntreaNetworkPolicySpecBuilder{}
	builder = builder.SetName(getNS("y"), "anp-deny-yb-to-xc-egress-port-range").
		SetPriority(1.0).
		SetAppliedToGroup([]ANPAppliedToSpec{{PodSelector: map[string]string{"pod": "b"}}})
	...
	testSteps = append(testSteps, &TestStep{
		Name:          fmt.Sprintf("ANP Drop Ports 8080:8082"),
		Reachability:  reachability,
		TestResources: []metav1.Object{builder.Get()},
		Ports:         []int32{8080, 8081, 8082},
		Protocol:      ProtocolTCP,
...
func testAuditLoggingBasic(t *testing.T, data *TestData) {
	...
	builder = builder.SetName(npRef).
		...
		SetAppliedToGroup([]ACNPAppliedToSpec{{PodSelector: map[string]string{"pod": "a"}, NSSelector: map[string]string{"ns": getNS("x")}}})
	builder.AddEgress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"ns": getNS("z")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", ruleName, nil)
...
func testAuditLoggingEnableNP(t *testing.T, data *TestData) {
	...
	k8sNPBuilder := &NetworkPolicySpecBuilder{}
	k8sNPBuilder = k8sNPBuilder.SetName(getNS("x"), npRef).
		SetPodSelector(map[string]string{"pod": "a"}).
		SetTypeIngress().
		AddIngress(v1.ProtocolTCP, &p80, nil, nil, nil,
	...
	oneProbe(getNS("x"), "b", getNS("x"), "a")
	oneProbe(getNS("x"), "c", getNS("x"), "a")
	wg.Wait()
...
func testAppliedToPerRule(t *testing.T) {
	...
	builder2.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("x")},
		nil, nil, nil, []ACNPAppliedToSpec{cnpATGrp1}, crdv1alpha1.RuleActionDrop, "", "", nil)
	builder2.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("z")},
		nil, nil, nil, []ACNPAppliedToSpec{cnpATGrp2}, crdv1alpha1.RuleActionDrop, "", "", nil)
...
func testACNPClusterGroupServiceRefCreateAndUpdate(t *testing.T, data *TestData) {
	...
	builder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		nil, nil, crdv1alpha1.RuleActionDrop, cg2Name, "", nil)
	...
	builderUpdated.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("y")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
...
func testACNPNestedClusterGroupCreateAndUpdate(t *testing.T, data *TestData) {
	...
	builder = builder.SetName("cnp-nested-cg").SetPriority(1.0).
		...
		AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
			nil, nil, crdv1alpha1.RuleActionDrop, cgNestedName, "", nil)
...
func testACNPNestedIPBlockClusterGroupCreateAndUpdate(t *testing.T) {
	...
	builder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, cgParentName, "", nil)
...
func testACNPNamespaceIsolation(t *testing.T) {
	...
	builder.AddIngress(ProtocolTCP, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		selfNamespace, nil, crdv1alpha1.RuleActionAllow, "", "", nil)
	...
	builder2.AddEgress(ProtocolTCP, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		selfNamespace, []ACNPAppliedToSpec{{NSSelector: map[string]string{"ns": getNS("x")}}}, crdv1alpha1.RuleActionAllow, "", "", nil)
	builder2.AddEgress(ProtocolTCP, nil, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{}, nil, nil,
		nil, []ACNPAppliedToSpec{{NSSelector: map[string]string{"ns": getNS("x")}}}, crdv1alpha1.RuleActionDrop, "", "", nil)
...
func testACNPStrictNamespacesIsolation(t *testing.T) {
	...
	builder = builder.SetName("test-acnp-strict-ns-isolation").
		...
		SetAppliedToGroup([]ACNPAppliedToSpec{{NSSelector: map[string]string{}}})
	builder.AddIngress(ProtocolTCP, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		selfNamespace, nil, crdv1alpha1.RuleActionPass, "", "", nil)
	builder.AddIngress(ProtocolTCP, nil, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{}, nil, nil,
		nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
...
func testACNPStrictNamespacesIsolationBySingleLabel(t *testing.T, data *TestData) {
	samePurposeLabels := &crdv1alpha1.PeerNamespaces{
	...
	builder = builder.SetName("test-acnp-strict-ns-isolation-by-single-purpose-label").
		...
		SetAppliedToGroup([]ACNPAppliedToSpec{{NSSelector: map[string]string{}}})
	builder.AddIngress(ProtocolTCP, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		samePurposeLabels, nil, crdv1alpha1.RuleActionPass, "", "", nil)
	builder.AddIngress(ProtocolTCP, nil, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{}, nil, nil,
		nil, nil, crdv1alpha1.RuleActionDrop, "", "", nil)
...
func testFQDNPolicyInClusterService(t *testing.T) {
	...
	for idx, service := range services {
		builder.AddFQDNRule(svcDNSName(service), ProtocolTCP, nil, nil, nil, fmt.Sprintf("r%d", idx*2), []ACNPAppliedToSpec{{NSSelector: map[string]string{"ns": getNS("y")}, PodSelector: map[string]string{"pod": "b"}}}, crdv1alpha1.RuleActionReject)
		builder.AddFQDNRule(svcDNSName(service), ProtocolTCP, nil, nil, nil, fmt.Sprintf("r%d", idx*2+1), []ACNPAppliedToSpec{{NSSelector: map[string]string{"ns": getNS("z")}, PodSelector: map[string]string{"pod": "c"}}}, crdv1alpha1.RuleActionDrop)
	}
	acnp := builder.Get()
	k8sUtils.CreateOrUpdateACNP(acnp)
	failOnError(waitForResourceReady(t, timeout, acnp), t)
...
func testToServices(t *testing.T) {
	...
	builder = builder.SetName("test-acnp-to-services").
		SetTier("application").
		SetPriority(1.0)
	builder.AddToServicesRule(svcRefs, "svc", []ACNPAppliedToSpec{{NSSelector: map[string]string{"ns": getNS("y")}}}, crdv1alpha1.RuleActionDrop)
	time.Sleep(networkPolicyDelay)
...
func testServiceAccountSelector(t *testing.T, data *TestData) {
	...
	builder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, nil,
		nil, nil, nil, nil, crdv1alpha1.RuleActionDrop, "", "", sa)
	...
	if clusterInfo.podV4NetworkCIDR != "" {
		ipv4Testcases := []podToAddrTestStep{
			{
				Pod(getNS("x") + "/" + client0Name),
				serverIP.ipv4.String(),
				80,
				Dropped,
			},
			{
				Pod(getNS("x") + "/" + client1Name),
				serverIP.ipv4.String(),
				80,
				Connected,
			},
...
func TestAntreaPolicyStatus(t *testing.T) {
	...
	anpBuilder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("x")}, nil,
		nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "")
	anp := anpBuilder.Get()
	...
	acnpBuilder = acnpBuilder.SetName("acnp-applied-to-two-nodes").
		SetPriority(1.0).
		SetAppliedToGroup([]ACNPAppliedToSpec{{PodSelector: map[string]string{"app": "nginx"}}})
	acnpBuilder.AddIngress(ProtocolTCP, &p80, nil, nil, nil, nil, nil, nil, nil, map[string]string{"pod": "b"}, map[string]string{"ns": getNS("x")},
		nil, nil, nil, nil, crdv1alpha1.RuleActionAllow, "", "", nil)
...
// AntreaPolicyStats related test cases so that they can share setup and teardown.
